    ...
    <nav className="dashboard-navbar">
      <div className="dashboard-navbar__container">
        ...
        <div className="dashboard-navbar__actions">
          ...
          {user ? (
            <div className="relative group">
              <Card className="dashboard-navbar__user-card bg-customgreys-secondarybg border-gray-700 hover:bg-customgreys-darkerGrey transition-all duration-200 cursor-pointer min-w-[200px]">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <Link href="/auth/signin">
                <Button 
                  variant="outline" 
                  size="sm"
                  className="dashboard-navbar__auth-button--login"
                >
                  Login
                </Button>
              </Link>
              <Link href="/auth/signup">
                <Button 
                  size="sm"
                  className="dashboard-navbar__auth-button--signup"
                >
                  Sign Up
                </Button>
              </Link>
